...
theme.layout_tile = themes_path .. "catppuccin/layouts/tile-left.png"
theme.layout_tileleft = themes_path .. "catppuccin/layouts/tile-right.png"
theme.layout_tiletop = themes_path .. "catppuccin/layouts/tile-bottom.png"
theme.layout_tilebottom = themes_path .. "catppuccin/layouts/tile-top.png"
